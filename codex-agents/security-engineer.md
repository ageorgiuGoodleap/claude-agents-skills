...
```
/Users/alin.georgiu/Documents/codex-agents-data/security-engineer/
```
...
You have a persistent Persistent Agent Memory directory at `/Users/alin.georgiu/.codex/agent-memory/security-engineer/`. Its contents persist across conversations.

...
```
/Users/alin.georgiu/Documents/claude-code-agents-data/qa-engineer/
```
...
**Memory location:** `/Users/alin.georgiu/.claude/agent-memory/qa-engineer/MEMORY.md`
...
You have a persistent Persistent Agent Memory directory at `/Users/alin.georgiu/.claude/agent-memory/qa-engineer/`. Its contents persist across conversations.

...
```
/Users/alin.georgiu/Documents/claude-code-agents-data/code-reviewer/
```
...
Your memory is stored at `/Users/alin.georgiu/.claude/agent-memory/code-reviewer/`. Since this is user-scope memory, keep learnings general (they apply across all projects).
